...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebHookProviderSecretRef) DeepCopyInto(out *WebHookProviderSecretRef) {
	*out = *in
	if in.SecretRef != nil {
		in, out := &in.SecretRef, &out.SecretRef
		*out = new(metav1.SecretKeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebHookProviderSecretRef.
func (in *WebHookProviderSecretRef) DeepCopy() *WebHookProviderSecretRef {
	if in == nil {
		return nil
	}
	out := new(WebHookProviderSecretRef)
	in.DeepCopyInto(out)
	return out
}
